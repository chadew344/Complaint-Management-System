    ...
    <div class="content-wrapper">
      <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
          ...
          <a href="complaint?action=get" class="nav-link">
      ...
      <main class="main-content">
        <div class="container-fluid">
          <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
              <h3 class="fw-light">Hi ${welcomeName},</h3>
          ...
          <div class="row mb-4">
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="summary-card border-left-primary h-100">
                <div class="card-body">
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="summary-card border-left-success h-100">
                <div class="card-body">
                  <div class="d-flex justify-content-between">
                    <div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="summary-card border-left-warning h-100">
                <div class="card-body">
                  <div class="d-flex justify-content-between">
                    <div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="summary-card border-left-danger h-100">
                <div class="card-body">
                  <div class="d-flex justify-content-between">
                    <div>
                      <div class="card-title">IN-PROGRESS</div>
                      <div class="card-value">${in_progress}</div>
                    </div>
    ...
    >
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form  action="user"  id="passwordChangeForm" method="post">
              <div class="mb-3">
          ...
          <div class="modal-footer">
            ...
            <button type="submit" class="btn btn-primary" id="savePasswordBtn"  name="action" value="changePassword" >
              Save Changes
            </button>
          </div>
        </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <a href="login?action=logout" class="btn btn-danger">Logout
            </a>
          </div>
        </div>
      </div>
